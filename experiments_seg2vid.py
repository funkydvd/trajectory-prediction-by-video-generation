...
tree2 = ET.parse(annotated_xml[2])
root2 = tree2.getroot()
		...
		for child_1 in root2:
			if 'name' in child_1.attrib:
				...
				if data2[0] == data[0] and data2[1] == data[1]:
					if int(data2[2][1])+1 == ord1[data[0]][data[1]][data[2]]:
						used_obj = []
						for child2 in child:
							used_obj.append(0)
						
						numeimg = './raw_data/seg2vid_small/' + path2
						...
						depth_file2 = depth_folders[2] + data[0] + "/" + data[1] + "/" + data2[2][:-4] + "_disp.jpeg"
						#print(depth_file1)
						#print(depth_file2)
						...
						for y in ord1[data[0]][data[1]]:
							if ord1[data[0]][data[1]][y] ==1:
								...
								predicted = raws_folders[2] + data2[0]+ "/" + data2[1] + "/" + data2[2]
								numeimg = './raw_data/seg2vid_small/' + path2
								#print(numeimg)
								#sprint(predicted)
								#img_default = cv2.imread(numeimg, 0)
								...
								segm_file_fcn2 = segm_folders[2] + path2[:-4] + "_fcn.png"
