...
segm_folders = ["./fcn_data/prednet_small_fcn/", "./fcn_data/videoPrediction_small_fcn/","./fcn_data/seg2vid_small_fcn/"]
raws_folders = ["./raw_data/prednet_small/","./raw_data/videoPrediction_small/","./raw_data/seg2vid_small/"] 
...
tree2 = ET.parse(annotated_xml[1])
root2 = tree2.getroot()
		...
		for child_1 in root2:
			if 'name' in child_1.attrib:
				...
				if data2[0] == data[0] and data2[1] == data[1]:
					if int(data2[6][1])+1 == ord1[data[0]][data[1]][data[2]]:
						#print(path)
						#print(path2)						
						used_obj = []
						for child2 in child:
						...
						numeimg = './raw_data/videoPrediction_small/' + path2
						...
						depth_file2 = depth_folders[1] + data[0] + "/" + data[1] + "/" +data2[2] +"_" + data2[3]+"_"+ 	data2[4]+"_"+data2[5]+"_"+ data2[6][:-4] + "_disp.jpeg"
						#print(depth_file2)
						...
						for y in ord1[data[0]][data[1]]:
							if ord1[data[0]][data[1]][y] ==1:
								...
								predicted = raws_folders[1] + data2[0]+ "/" + data2[1] + "/" + data2[2]
								numeimg = './raw_data/videoPrediction_small/' + path2
								#print(numeimg)
								#sprint(predicted)
								#img_default = cv2.imread(numeimg, 0)
								
								img0 = cv2.imread(numeimg,0)
								...
								segm_file_fcn2 = segm_folders[1] + path2[:-4] + "_fcn.png"
									...
									for child2 in child_1:
										...
										for ind in range(len(child)):
											if used_obj_segm[ii][ind] == 0:
												...
												procxo1 = (xo1-min_w2)/ (max_w4-min_w4)
												procxo2 = (xo2-min_w2)/ (max_w4-min_w4)
												procyo1 = (yo1-min_h2)/ (max_h4-min_h4)
												procyo2 = (yo2-min_h2)/ (max_h4-min_h4)
...
#	print(child.attrib)
	...
	if 'name' in child.attrib:
		...
		for x in datas:
			...
			#print(data2)
			path2 = data2[0] + "/" + data2[1] +"/" + data2[2]
			data2_aux = data2[2].split("_") 	
			if data2[0] == data[0] and data2[1] == data[1]:
				if int(data2_aux[4][1])+1 == ord1[data[0]][data[1]][data[2]]:
				#print(x['filename'])
					#print(x)
					...
					depth_file2 = depth_folders[1] + data[0] + "/" + data[1] + "/" +data2[2][:-4] + "_disp.jpeg"
					#print(depth_file2)
					imgd2 = cv2.imread(depth_file2,0)
					imgd2 = cv2.resize(imgd2, (img_default.shape[1],img_default.shape[0]),interpolation=cv2.INTER_AREA)
									...
									for ind in range(len(child)):
										if used_obj_segm[ii][ind] == 0:
											...
											for x_json in datas:
												...
												#print(data2_json)
												data2_aux = data2_json[2].split("_")
												if data2_json[0] == data[0] and data2_json[1] == data[1]:
													if int(data2_aux[4][1]) == 0:
